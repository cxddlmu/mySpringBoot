...
public class RedisUtils {
     ...
     * @return
     */
    public long setIfAbsentincr(String key, long delta) {
        if (delta < 0) {
    ...
    public Set<ZSetOperations.TypedTuple<Object>> rangeByScoreWithScores(String key, double v1, double v2) {
...
//    public Boolean setIfAbsent(String key,String value,Long lockTimeOut){
